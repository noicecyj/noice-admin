package noice.repository.create.bean;
...
import noice.mapper.create.bean.PersistentTableSearchConfigMapper;
...
public class PersistentTableSearchConfigRepository implements BeanRepository<PersistentTableSearchConfigPo> {
    ...
    @Override
    public String delete(PersistentTableSearchConfigPo po) {
    ...
    @Override
    public int deleteBatch(List<PersistentTableSearchConfigPo> poList) {
        return mapper.deleteByIds(poList.stream().map(PersistentTableSearchConfigPo::getId).collect(Collectors.toList()));
    }
