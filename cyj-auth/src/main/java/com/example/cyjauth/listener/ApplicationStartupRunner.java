package com.example.cyjauth.listener;

import com.alibaba.fastjson.JSON;
import com.example.cyjauth.entity.dto.AuthorityDTO;
...
public class ApplicationStartupRunner implements CommandLineRunner {
        ...
        private void interFaceHandler() {
                Map<String, Object> Tag = applicationContext.getBeansWithAnnotation(Tag.class);
