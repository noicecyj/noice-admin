...
import pageStore from '@/pages/TestPaperConfig/store';
import DataFormTemple from '@/components/dataForm';
import DataTableTemple from '@/components/dataTable';
import {CustomColumn} from '@/pages/TestPaperConfig/view/custom/TestPaperConfig';

function TestPaperConfig() {

  const [state, dispatchers] = pageStore.useModel('testPaperConfig');

  const [customState, customDispatchers] = pageStore.useModel('testPaperConfigCustom');
