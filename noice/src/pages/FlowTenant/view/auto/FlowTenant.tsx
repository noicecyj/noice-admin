...
import {CustomColumn} from '@/pages/FlowTenant/view/custom/FlowTenant';

function FlowTenant() {

  const [state, dispatchers] = pageStore.useModel('flowTenant');

  const [customState, customDispatchers] = pageStore.useModel('flowTenantCustom');
