...
import service from '@/pages/PersistentTableConfig/services/PersistentTableConfig';

export default {

  namespace: 'PersistentTableConfig',
  ...
  effects: (dispatch) => ({
    async page(data) {
      ...
      dispatch.PersistentTableConfig.setState(payload);
    },
    async save(data) {
    ...
    async findDataTableAndFormByName() {
      const ret = await initService.findDataTableAndFormByName('persistent_table_config');
      await this.page({
