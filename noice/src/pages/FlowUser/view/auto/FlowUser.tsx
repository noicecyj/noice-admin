...
import {CustomColumn} from '@/pages/FlowUser/view/custom/FlowUser';

function FlowUser() {

  const [state, dispatchers] = pageStore.useModel('flowUser');

  const [customState, customDispatchers] = pageStore.useModel('flowUserCustom');
