...
import service from '@/pages/PersistentTableSearchConfig/services/PersistentTableSearchConfig';

export default {

  namespace: 'PersistentTableSearchConfig',
  ...
  effects: (dispatch) => ({
    async page(data) {
      ...
      dispatch.PersistentTableSearchConfig.setState(payload);
    },
    async save(data) {
    ...
    async findDataTableAndFormByName() {
      const ret = await initService.findDataTableAndFormByName('persistent_table_search_config');
      await this.page({
