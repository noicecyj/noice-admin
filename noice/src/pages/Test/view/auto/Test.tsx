...
import {CustomColumn} from '@/pages/Test/view/custom/Test';

function Test() {

  const [state, dispatchers] = pageStore.useModel('test');

  const [customState, customDispatchers] = pageStore.useModel('testCustom');
