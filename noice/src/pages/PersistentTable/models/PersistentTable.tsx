...
import service from '@/pages/PersistentTable/services/PersistentTable';

export default {

  namespace: 'PersistentTable',
  ...
  effects: (dispatch) => ({
    async page(data) {
      ...
      dispatch.PersistentTable.setState(payload);
    },
    async save(data) {
    ...
    async findDataTableAndFormByName() {
      const ret = await initService.findDataTableAndFormByName('persistent_table');
      await this.page({
