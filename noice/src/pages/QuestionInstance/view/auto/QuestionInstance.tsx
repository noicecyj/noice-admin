...
import pageStore from '@/pages/QuestionInstance/store';
import DataFormTemple from '@/components/dataForm';
import DataTableTemple from '@/components/dataTable';
import {CustomColumn} from '@/pages/QuestionInstance/view/custom/QuestionInstance';

function QuestionInstance() {

  const [state, dispatchers] = pageStore.useModel('questionInstance');

  const [customState, customDispatchers] = pageStore.useModel('questionInstanceCustom');
