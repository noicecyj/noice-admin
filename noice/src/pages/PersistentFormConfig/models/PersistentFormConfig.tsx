...
import service from '@/pages/PersistentFormConfig/services/PersistentFormConfig';

export default {

  namespace: 'PersistentFormConfig',
  ...
  effects: (dispatch) => ({
    async page(data) {
      ...
      dispatch.PersistentFormConfig.setState(payload);
    },
    async save(data) {
    ...
    async findDataTableAndFormByName() {
      const ret = await initService.findDataTableAndFormByName('persistent_form_config');
      await this.page({
