...
import service from '@/pages/UserRole/services/UserRole';
...
export default {
  ...
  effects: (dispatch) => ({
    async page(data) {
      ...
      dispatch.UserRole.setState(payload);
    },
    async save(data) {
    ...
    async findDataTableAndFormByName() {
      const ret = await initService.findDataTableAndFormByName('user_role');
      await this.page({
