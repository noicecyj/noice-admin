...
import service from '@/pages/LoanApproval/services/auto/LoanApproval';
...
export default {
  ...
  effects: (dispatch) => ({
    async page(current) {
      ...
      dispatch.loanApproval.setState(payload);
    },
    async save(data) {
    ...
    async findDataTableAndFormByName() {
      const ret = await initService.findDataTableAndFormByName('loan_approval');
      await this.page(1);
      const payload = {
