...
import pageStore from '@/pages/LoanApproval/store';
import DataFormTemple from '@/components/dataForm';
import DataTableTemple from '@/components/dataTable';
import {CustomColumn} from '@/pages/LoanApproval/view/custom/LoanApproval';

function LoanApproval() {

  const [state, dispatchers] = pageStore.useModel('loanApproval');

  const [customState, customDispatchers] = pageStore.useModel('loanApprovalCustom');
