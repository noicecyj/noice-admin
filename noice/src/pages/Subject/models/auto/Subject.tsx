...
import service from '@/pages/Subject/services/auto/Subject';
...
export default {
  ...
  effects: (dispatch) => ({
    async page(current) {
      ...
      dispatch.subject.setState(payload);
    },
    async save(data) {
    ...
    async findDataTableAndFormByName() {
      const ret = await initService.findDataTableAndFormByName('subject');
      await this.page(1);
      const payload = {
