...
import pageStore from '@/pages/Subject/store';
import DataFormTemple from '@/components/dataForm';
import DataTableTemple from '@/components/dataTable';
import {CustomColumn} from '@/pages/Subject/view/custom/Subject';

function Subject() {

  const [state, dispatchers] = pageStore.useModel('subject');

  const [customState, customDispatchers] = pageStore.useModel('subjectCustom');
