...
import pageStore from '@/pages/Question/store';
import DataFormTemple from '@/components/dataForm';
import DataTableTemple from '@/components/dataTable';
import {CustomColumn} from '@/pages/Question/view/custom/Question';

function Question() {

  const [state, dispatchers] = pageStore.useModel('question');

  const [customState, customDispatchers] = pageStore.useModel('questionCustom');
