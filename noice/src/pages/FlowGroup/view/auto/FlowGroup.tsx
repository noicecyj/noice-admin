...
import {CustomColumn} from '@/pages/FlowGroup/view/custom/FlowGroup';

function FlowGroup() {

  const [state, dispatchers] = pageStore.useModel('flowGroup');

  const [customState, customDispatchers] = pageStore.useModel('flowGroupCustom');
