...
import pageStore from '@/pages/QuestionInstanceAnswer/store';
import DataFormTemple from '@/components/dataForm';
import DataTableTemple from '@/components/dataTable';
import {CustomColumn} from '@/pages/QuestionInstanceAnswer/view/custom/QuestionInstanceAnswer';

function QuestionInstanceAnswer() {

  const [state, dispatchers] = pageStore.useModel('questionInstanceAnswer');

  const [customState, customDispatchers] = pageStore.useModel('questionInstanceAnswerCustom');
...
export default QuestionInstanceAnswer;
