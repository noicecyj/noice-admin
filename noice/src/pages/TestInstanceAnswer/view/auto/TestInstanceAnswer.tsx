...
import pageStore from '@/pages/TestInstanceAnswer/store';
import DataFormTemple from '@/components/dataForm';
import DataTableTemple from '@/components/dataTable';
import {CustomColumn} from '@/pages/TestInstanceAnswer/view/custom/TestInstanceAnswer';

function TestInstanceAnswer() {

  const [state, dispatchers] = pageStore.useModel('testInstanceAnswer');

  const [customState, customDispatchers] = pageStore.useModel('testInstanceAnswerCustom');
...
export default TestInstanceAnswer;
