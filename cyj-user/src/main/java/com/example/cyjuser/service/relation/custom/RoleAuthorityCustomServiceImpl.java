...
public class RoleAuthorityCustomServiceImpl
    ...
    @Before(value = "execution(* com.example.cyjuser.service.relation.auto.RoleAuthorityServiceImpl.getRoleAuthority(..))")
    public void getRoleAuthorityBefore(JoinPoint joinPoint) {
        logger.info("RoleAuthorityService.getRoleAuthority.Before:{}", joinPoint);
    }

    @After(value = "execution(* com.example.cyjuser.service.relation.auto.RoleAuthorityServiceImpl.getRoleAuthority(..))")
    public void getRoleAuthorityAfter(JoinPoint joinPoint) {
        logger.info("RoleAuthorityService.getRoleAuthority.After:{}", joinPoint);
    }

    @Before(value = "execution(* com.example.cyjuser.service.relation.auto.RoleAuthorityServiceImpl.setRoleAuthority(..))")
    public void setRoleAuthorityBefore(JoinPoint joinPoint) {
        logger.info("RoleAuthorityService.setRoleAuthority.Before:{}", joinPoint);
    }

    @After(value = "execution(* com.example.cyjuser.service.relation.auto.RoleAuthorityServiceImpl.setRoleAuthority(..))")
