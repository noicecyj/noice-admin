...
public class PersistentPo extends BasePoBean<PersistentPo> {
    ...
    public PersistentPo eqAuto() {
        return this.eqPersistentCascade().eqPersistentCode().eqPersistentId().eqPersistentName().eqPersistentType();
    }

    public PersistentPo likeAuto() {
        return this.likePersistentCode().eqPersistentId().likePersistentName().likePersistentType();
    }
