...
## 2024-03-22 22:00:54 noice 作者大大 曹元杰 天才 笔记本
...
public class InterfacePo extends BasePoBean<InterfacePo> {
    ...
    public InterfacePo selectStatus() {
        this.queryWrapper.lambda().select(InterfacePo::isStatus);
        return this;
    }

    public InterfacePo eqStatus() {
        this.queryWrapper.lambda().eq(InterfacePo::isStatus, isStatus());
        return this;
    }
...
```
## 2024-10-11 18:47:41 noice 作者大大 曹元杰 天才 笔记本
...
public class InterfacePo extends BasePoBean<InterfacePo> {
    ...
    public InterfacePo eqStatus() {
        this.queryWrapper.lambda().eq(InterfacePo::getStatus, getStatus());
        return this;
    }
    ...
    public InterfacePo eqSortCode(long value) {
        ...
        this.queryWrapper.lambda().eq(InterfacePo::getSortCode, getSortCode());
        return this;
    }
...
public class InterfacePo extends BasePoBean<InterfacePo> {
    ...
    public InterfacePo eqStatus() {
        this.queryWrapper.lambda().eq(ObjectUtil.isNull(getStatus()), InterfacePo::getStatus, getStatus());
        return this;
    }
    ...
    public InterfacePo eqSortCode(Long value) {
        this.setSortCode(value);
        this.queryWrapper.lambda().eq(ObjectUtil.isNull(getSortCode()), InterfacePo::getSortCode, getSortCode());
        return this;
    }
