...
@CrossOrigin
@RestController
@RequestMapping("api/PersistentTable")
...
import io.swagger.v3.oas.annotations.tags.Tag;
import noice.common.entity.vo.ResultVO;
import noice.converter.create.bean.PersistentTableControllerConverter;
...
public class PersistentTableController implements BeanController<PersistentTableVo> {
    ...
    private noice.assembler.create.bean.PersistentTableControllerAssembler assembler;
    ...
    @Autowired
    public void setAssembler(noice.assembler.create.bean.PersistentTableControllerAssembler assembler) {
...
import io.swagger.v3.oas.annotations.Operation;
import io.swagger.v3.oas.annotations.tags.Tag;
import noice.assembler.create.bean.PersistentTableControllerAssembler;
import noice.common.entity.vo.ResultVO;
import noice.converter.create.bean.PersistentTableControllerConverter;
import noice.entity.vo.bean.PersistentTableVo;
import noice.handler.bean.BeanController;
...
public class PersistentTableController implements BeanController<PersistentTableVo> {
    ...
    private noice.converter.create.bean.PersistentTableControllerConverter converter;
...
public class PersistentTableController implements BeanController<PersistentTableVo> {
    ...
    @Autowired
    public void setConverter(noice.converter.create.bean.PersistentTableControllerConverter converter) {
        this.converter = converter;
    }
