...
public class PersistentTableConfigController implements BeanController<PersistentTableConfigVo> {
    ...
    private noice.converter.create.bean.PersistentTableConfigControllerConverter converter;

    private noice.assembler.create.bean.PersistentTableConfigControllerAssembler assembler;
    ...
    @Autowired
    public void setConverter(noice.converter.create.bean.PersistentTableConfigControllerConverter converter) {
        this.converter = converter;
    }

    @Autowired
    public void setAssembler(noice.assembler.create.bean.PersistentTableConfigControllerAssembler assembler) {
...
## 2024-12-10 14:32:48 noice 作者大大 曹元杰 天才 笔记本
...
public class PersistentTableConfigController implements BeanController<PersistentTableConfigVo> {
    ...
    @Override
    public ResultVO getOptions(@RequestBody PersistentTableConfigVo vo) {
        IPage<PersistentTableConfigVo> convert = service.findPage(converter.voToDto(vo)).convert(dto -> assembler.dtoToVo(dto));
        return ResultVO.success(new Page<OptionVO>(vo.getCurrent(), vo.getPageSize()).setTotal(convert.getTotal()).setRecords(convert.getRecords().stream().map(valueEnum -> OptionVO.builder().label(valueEnum.getPersistentTableConfigName()).value(valueEnum.getId()).build()).toList()));
    }
...
## 2024-12-13 15:48:18 noice 作者大大 曹元杰 天才 笔记本
...
## 2024-12-22 20:39:10 noice 作者大大 曹元杰 天才 笔记本
