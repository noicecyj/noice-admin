...
@CrossOrigin
@RestController
@RequestMapping("api/PersistentFormConfig")
...
public class PersistentFormConfigController implements BeanController<PersistentFormConfigVo> {
    ...
    private noice.converter.create.bean.PersistentFormConfigControllerConverter converter;
...
public class PersistentFormConfigController implements BeanController<PersistentFormConfigVo> {
    ...
    private noice.assembler.create.bean.PersistentFormConfigControllerAssembler assembler;
    ...
    @Autowired
    public void setConverter(noice.converter.create.bean.PersistentFormConfigControllerConverter converter) {
        this.converter = converter;
    }
...
## 2024-12-10 14:32:46 noice 作者大大 曹元杰 天才 笔记本
...
public class PersistentFormConfigController implements BeanController<PersistentFormConfigVo> {
    ...
    @Autowired
    public void setAssembler(noice.assembler.create.bean.PersistentFormConfigControllerAssembler assembler) {
        this.assembler = assembler;
    }
    ...
    @Override
    public ResultVO getOptions(@RequestBody PersistentFormConfigVo vo) {
        IPage<PersistentFormConfigVo> convert = service.findPage(converter.voToDto(vo)).convert(dto -> assembler.dtoToVo(dto));
        return ResultVO.success(new Page<OptionVO>(vo.getCurrent(), vo.getPageSize()).setTotal(convert.getTotal()).setRecords(convert.getRecords().stream().map(valueEnum -> OptionVO.builder().label(valueEnum.getPersistentFormConfigName()).value(valueEnum.getId()).build()).toList()));
    }
...
## 2024-12-13 01:24:56 noice 作者大大 曹元杰 天才 笔记本
