...
@Component
@Data
public class ConverterBeanMethodBuilder extends MethodBase {
    ...
    @Component
    @Data
    public static class dtoToPoBuilder extends ConverterBeanMethodBuilder {
    ...
    @Component
    @Data
    public static class dtoListToPoListBuilder extends ConverterBeanMethodBuilder {
    ...
    @Component
    @Data
    public static class dtoSetToPoSetBuilder extends ConverterBeanMethodBuilder {
    ...
    @Component
    @Data
    public static class voToDtoBuilder extends ConverterBeanMethodBuilder {
    ...
    @Component
    @Data
    public static class voListToDtoListBuilder extends ConverterBeanMethodBuilder {
    ...
    @Component
    @Data
    public static class voSetToDtoSetBuilder extends ConverterBeanMethodBuilder {
