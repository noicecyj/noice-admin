package noice.handler.builder.mapper.bean;
...
@Component
@Data
public class MapperBeanBuilder extends ClassBase {

    public MapperBeanBuilder builder(PersistentPo persistentPo) {
        ...
        this.setPackageName("package noice.mapper.bean;");
        this.setClassNote();
        this.setImportList(poName);
        this.setClassAnnotationList();
        this.setExtendsClassName("extends BaseMapper<" + poName + "Po>");
        return this;
    }
